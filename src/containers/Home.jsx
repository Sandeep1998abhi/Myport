    ...
    >
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 w-full">
        <div className="flex flex-col items-center justify-center w-full h-full gap-4 lg:items-start">
          ...
          <p className="mt-6 text-base text-center text-texlight lg:text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque autem perferendis qui, laboriosam fuga eaque porro minima amet dicta adipisci, quas repellat quidem, exercitationem fugit quam iure? Minus velit eos omnis dignissimos fugiat provident.</p>
